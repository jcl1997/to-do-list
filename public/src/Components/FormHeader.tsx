...
export default function FormHeader({ list, setList } : IFormHeader) {
        ...
        <form
            ...
            <div className="col-12">
                <label
                    ...
                    htmlFor={inputTask}>Tarefa</label>
                    ...
                    <input
                        ...
                        onChange={(event) => {
                            formTask.setFieldValue(
                                "task", event.target.value.toString()
                            );
                        }}
            ...
            <div className="col-12">
                ...
                <button type="button" className="btn btn-success me-1">Buscar</button>
...
const isRequired = Yup.string().required("Campo obrigatório.");